...
* `MR6NN`: 6th order strict Nystrom methöd of El-Mikkawy and Rahmo [19]. I couldn't find the interpolant that the paper refers to as future work. However, I created a free C2-continuous sixth order interpolant and added it to this method. This interpolant is an improvement over the default quintic interpolant for RKN methods, but its maximum error constant is large compared to the very low 7th order error constant of the main method.
